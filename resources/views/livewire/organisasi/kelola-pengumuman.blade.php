<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Pengumuman Organisasi</h2>
            <p class="text-sm text-slate-500 mt-1">Kelola informasi publik dan agenda kegiatan organisasi Anda.</p>
        </div>
                                    ...
                                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 border-dashed rounded-xl relative hover:bg-slate-50 transition-colors">
                                        <div class="space-y-1 text-center">
                                            ...
                                            <div class="flex text-sm text-slate-600 justify-center">
                                                <label for="file-upload-org" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500 px-1">
                                                    <span>Upload file</span>
                                                    <input id="file-upload-org" type="file" wire:model="file_lampiran" class="sr-only" accept=".pdf,.png,.jpg,.jpeg">
                                                </label>
