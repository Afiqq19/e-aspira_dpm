<div class="w-64 bg-white border-r border-slate-200 flex flex-col h-screen z-10 shadow-sm shrink-0">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        @role('admin')
            ...
            <a href="{{ route('admin.uu-kema.index') }}" wire:navigate class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ $this->isActive('admin.uu-kema.index') }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
        ...
        @role('staff_dewan')
            ...
            <a href="{{ route('dewan.evaluasi-proker.index') }}" wire:navigate class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ $this->isActive('dewan.evaluasi-proker.index') }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path></svg>
                <span class="font-medium">Pantau Evaluasi</span>
            </a>
            <a href="{{ route('dewan.evaluasi-bem.index') }}" wire:navigate class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ $this->isActive('dewan.evaluasi-bem.index') }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path></svg>
                <span class="font-medium">Beri Evaluasi BEM</span>
            </a>
            ...
            @endcan
            <a href="{{ route('dewan.uu-kema.index') }}" wire:navigate class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ $this->isActive('dewan.uu-kema.index') }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                <span class="font-medium">Kelola UU Kema</span>
            </a>
        @endrole
