    ...
    <form wire:submit="login">
        ...
        <div class="flex items-center justify-between mt-6">
            ...
            <div class="flex items-center">
                ...
                <x-primary-button class="w-full bg-indigo-600 hover:bg-indigo-700 transition duration-150 ease-in-out shadow-md shadow-indigo-500/30 justify-center text-sm py-2.5">
