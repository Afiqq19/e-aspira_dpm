...
class KelolaPengumuman extends Component
{
    ...
    {
        $query = Pengumuman::query()->with(['user'])->dpm();
    ...
    public function save()
    {
        ...
        $data = [
            ...
            'organisasi_id' => null, // Selalu DPM (null)
        ];
    ...
    {
        $this->pengumumanToDelete = Pengumuman::dpm()->findOrFail($id);
